...
Predictive models to assess customer credit risk for loan underwriting have been implemented in the financial industry. These models predict the risk at a point in time. Continuous assessment of credit risk can enable detection of change in customer behaviour. Banks can dynamically update product pricing or change the terms of a loan such as increase the credit line. This solution will have a two fold benefit of increased profitability for banks and increased customer satisfaction enabling them to build credit responsibly.

### Abstract of the second idea {-}
